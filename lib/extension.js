import { ExtensionSettingsDB } from './db.js';
import { request } from './req.js';
import * as cheerio from 'cheerio';

/**
 * @typedef {import("./types").ExtensionSettings} ExtensionSettings
 * @typedef {import("./types").Extension} ExtensionType
 * @typedef {import("./types").BangumiWatch} BangumiWatch
 * @typedef {import("./types").Detail} Detail
 * @typedef {import("./types").FikushonWatch} FikushonWatch
 * @typedef {import("./types").ListItem} ListItem
 * @typedef {import("./types").MangaWatch} MangaWatch
 */
...
export class Extension {
	...
	async request(url, options) {
		try {
			...
			originalConsole.error('Error making request:', error.message);
